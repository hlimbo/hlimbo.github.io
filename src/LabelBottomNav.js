...
export default function LabelBottomNavigation() {
  ...
  return (
    <BottomNavigaton value={value} onChange={handleChange} className={style.labelBottomNav}>
      ...
      <BottomNavigationAction target="_blank" rel="noopener noreferrer" component="a" href="mailto:limboh27@gmail.com" showLabel label="limboh27@gmail.com" value="email" icon={<EmailIcon />} />
